...
public class UnscheduledTicketAdapter extends FirestoreRecyclerAdapter<UnscheduledTicket, UnscheduledTicketAdapter.TicketHolder> {

    private onItemClickListener listener;

    public UnscheduledTicketAdapter(FirestoreRecyclerOptions<UnscheduledTicket> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull TicketHolder holder, int position, @NonNull UnscheduledTicket model) {
