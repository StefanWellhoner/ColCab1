...
public class MainActivity extends AppCompatActivity {
        ...
        colref.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                    ...
                    String dateScheduled = date.getDateScheduled();
                    ...
                    if(daysBetween > 0 && daysBetween < 5){
                        ...
                        displayNotification(daysBetween, id, customer, caseModel, count);
                    } //else {
                    // Will remove the negative number
                    //  System.out.println(daysBetween * -1);
                    // displayNotification(daysBetween * -1, id, customer, caseModel, count);
                    // }
                }
            }
        });
    ...
    private void displayNotification(long numDays, String id, String customer, String caseModel, int count) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, CHANNEL_ONE)
                        ...
                        .setStyle(new NotificationCompat.InboxStyle()
                                ...
                                .addLine(customer)
                                .addLine(caseModel)
                                .addLine("Dayes left: " + Long.toString(numDays)))
